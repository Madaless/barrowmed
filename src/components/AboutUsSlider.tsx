...
const AboutUsSlider = () => {
    const keenSliderRef = useRef<any | null>(null);
    ...
    useEffect(() => {
        ...
        keenSliderRef.current = keenSlider; // Set the Keen Slider instance in the ref

        return () => {
            // Clean up Keen Slider instance on component unmount
            keenSlider.destroy();
        };
    }, []); // Run effect only once on mount

    const handlePrevClick = () => {
        // Check if the Keen Slider instance exists in the ref
    ...
    return (
        ...
        // </div>
        <section className="bg-primary/10 mb-10">
            <div
                                ...
                                >
                                    <div>
                                        ...
                                        <div className="mt-4">
                                            ...
                                            <p className="mt-4 leading-relaxed text-gray-700">
                                                Noo, Rose, they are not breathing. And they have no arms or
                                                legs … Where are they? You know what? If we come across
                                                somebody with no arms or legs, do we bother resuscitating
                                                them? I mean, what quality of life do we have there?
                                            </p>
